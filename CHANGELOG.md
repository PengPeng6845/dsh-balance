...
- Widget shows only the balance itself: the tooltip no longer carries
  today's spend / update time / staleness text (low-balance hint kept).
- README mockup and feature list updated to match the real UI.
